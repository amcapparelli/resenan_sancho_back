...
const bookCopyRequestTemplate = (message, authorEmail, reviewerEmail, bookTitle, bookCopies) => {
  ...
  <p><b>ATENCIÓN: quedan ${bookCopies} ejemplares disponibles de este libro.</b></p>
  <p>${bookCopies === 0 ? 'El libro ya no se mostrará disponible a los reseñadores.' : 'Cuando llegue a 0 el libro no aparecerá más como disponible.'}</p>
  <p>Puedes añadir más ejemplares desde tu área privada, en la sección "Mis Libros", con la opción PROMOCIONAR.</p>
  <p>RESEÑAN SANCHO</p>
  `;
