...
const newBookTemplate = (authorEmail, authorName, bookTitle) => {
  ...
  const html = `;
  <p>Hola ${authorName},</p>
  <p>¡Ya has dado el primer paso para promocionar tu libro <b>${bookTitle}</b>!</p>
  ...
  <p>Empieza utilizando la opción PROMOCIONAR y selecciona <b>la oferta para añadir ejemplares gratuitos</b> para probar el servicio.</p>
